...
<%@ page import="com.atlassian.jira.config.CoreFeatures" %>
...
<body>
<% boolean canAddUsers = ComponentAccessor.getUserManager().hasWritableDirectory(); %>
<% boolean isOnDemand = ComponentManager.getComponentInstanceOfType(FeatureManager.class).isEnabled(CoreFeatures.ON_DEMAND); %>
            ...
            <div class="toolbar-split toolbar-split-right">
                <ul class="toolbar-group">
                    <li class="toolbar-item">
                        <a href="<%= request.getContextPath() %>/secure/admin/user/AddUser!default.jspa" class="toolbar-trigger<% if (!isOnDemand) { %> trigger-dialog <% } %>" id="add_user">
...
<table class="aui aui-table-rowhover" id="user_browser_table">
    ...
    <tr class="vcard">
        <td><div><a id="<ww:property value="name"/>" rel="<ww:property value="name"/>" class="user-hover user-avatar" style="background-image:url(<ww:property value="/avatarUrl(name)"/>);" href="<ww:url page="ViewUser.jspa"><ww:param name="'name'" value="name"/></ww:url>"><span class="username"><ww:property value="name"/></span></a></div></td>
        <td>
