                ...
                <ul class="toolbar-group">
                    <ww:if test="/customFieldTypesExist == true">
                        <li class="toolbar-item">
                            <a id="add_custom_fields" class="toolbar-trigger xtrigger-dialog" href="<ww:url value="'/secure/admin/CreateCustomField!default.jspa'" />">
                    ...
                    <tbody>
                        ...
                        <tr <ww:if test="@status/modulus(2) != 1">class="rowAlternate"</ww:if>>
                            <td id="custom-fields-<ww:property value="./id" />-name">
                                ...
                                <div class="secondary-text description"><ww:property value="description" escape="false"/></div>
                            </td>
                                        ...
                                        <ww:iterator value="/fieldScreenTabs(.)" status="'tabStatus'">
                                            <li>
                                                <ww:if test="./fieldScreen/tabs/size > 1">
                                                    <a href="<ww:url value="'/secure/admin/ConfigureFieldScreen.jspa'"><ww:param name="'id'" value="./fieldScreen/id" /><ww:param name="'tabPosition'" value="./position" /></ww:url>"><ww:property value="./fieldScreen/name" /></a> (<ww:property value="./name" />)
                                                </ww:if>
                                                <ww:else>
                                                    <a href="<ww:url value="'/secure/admin/ConfigureFieldScreen.jspa'"><ww:param name="'id'" value="./fieldScreen/id" /></ww:url>"><ww:property value="./fieldScreen/name" /></a>
                                                </ww:else>
                                            </li>
                                        </ww:iterator>
                                    </ul>
                                ...
                                <div class="aui-dd-parent">
                                    ...
                                    <div class="aui-list hidden">
                                        <ul class="aui-list-section aui-first aui-last">
                                            <li class="aui-list-item"><a class="aui-list-item-link" id="config_<ww:property value="./id" />" href="<ww:url value="'ConfigureCustomField!default.jspa'"><ww:param name="'customFieldId'" value="genericValue/long('id')" /></ww:url>"><ww:text name="'admin.common.words.configure'"/></a></li>
                                            <li class="aui-list-item"><a class="aui-list-item-link" id="edit_<ww:property value="./name" />" href="<ww:url value="'EditCustomField!default.jspa'"><ww:param name="'id'" value="genericValue/long('id')" /></ww:url>"><ww:text name="'common.words.edit'"/></a></li>
                                            <li class="aui-list-item"><a class="aui-list-item-link" id="associate_<ww:property value="./id" />" href="<ww:url value="'AssociateFieldToScreens!default.jspa'"><ww:param name="'fieldId'" value="id" /><ww:param name="'returnUrl'" value="'ViewCustomFields.jspa'" /></ww:url>"><ww:text name="'admin.issuefields.screens'"/></a></li>
                                            <li class="aui-list-item"><a class="aui-list-item-link" id="del_<ww:property value="./id" />" href="<ww:url value="'DeleteCustomField!default.jspa'"><ww:param name="'id'" value="genericValue/long('id')" /></ww:url>"><ww:text name="'common.words.delete'"/></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </td>
