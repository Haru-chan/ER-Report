...
<page:applyDecorator name="jiraform">
    ...
    <page:param name="buttons">
        <input class="aui-button" type="reset" value="<ww:text name="'admin.common.words.reset'"/>" onclick="window.location='<ww:url value="'ConfigureOptionSchemes!default.jspa'" ><ww:param name="'fieldId'" value="/fieldId" /><ww:param name="'schemeId'" value="/schemeId" /><ww:param name="'returnUrl'" value="/returnUrl" /></ww:url>';return false;"/>
    </page:param>
    </ww:if>
