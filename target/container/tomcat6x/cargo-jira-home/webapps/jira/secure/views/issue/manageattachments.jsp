...
<ww:if test="/issueValid == true">
    ...
    <div id="issue-attachments-table">
                ...
                <table class="aui" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr<ww:if test="@status/odd == false"> class="alt"</ww:if>>
                            ...
                            <td class="icon">
                                <ww:if test="/hasDeleteAttachmentPermission(./id) == true"> <a title="<ww:text name="'attachment.delete.tooltip'"/>" href="<ww:url page="DeleteAttachment!default.jspa"><ww:param name="'id'" value="/issueObject/id" /><ww:param name="'deleteAttachmentId'" value="./id" /></ww:url>" id="del_<ww:property value="./id" />" class="icon icon-delete delete"><span><ww:text name="'common.words.delete'"/></span></a></ww:if>
                            </td>
                        </tr>
                        </ww:iterator>
                    </tbody>
