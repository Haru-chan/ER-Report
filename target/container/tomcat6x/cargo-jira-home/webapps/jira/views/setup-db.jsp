...
<page:applyDecorator id="jira-setupwizard" name="auiform">
    ...
    <page:applyDecorator name="auifieldgroup">
        <page:param name="description">
         ...
         <aui:select id="'server-language'" label="text('setup.choose.language')" name="'serverLanguage'" list="installedLocales" listKey="'toString'" listValue="'displayName'" mandatory="'true'" theme="'aui'">
