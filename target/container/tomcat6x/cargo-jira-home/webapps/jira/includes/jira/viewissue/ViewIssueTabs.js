...
JIRA.ViewIssueTabs = (function() {
    ...
    return {
        ...
        domReady: function() {
            ...
            this.onTabReady(bindToTabDivs);
            this.onTabReady(processActivityModuleLinks);

            // call the "tab loaded" event handlers
            dispatchIssueTabLoadedEvent(document);
        }
    }
})();
