...
AJS.SelectModel = AJS.Control.extend({
    ...
    setSelected: function (descriptor) {
        ...
        var instance = this,
            selectedItem = false,
            changed = false,
            $toSelect = this.$element.find("option").filter(function() {
    ...
    _parseDescriptors: function () {
        ...
        function parseOptGroup (optionGroup) {
            ...
            var weight = optionGroup.attr('data-weight');
            if (weight) {
    ...
    getUnSelectedDescriptors: function (context) {
        ...
        var selectedDescriptors = this.getSelectedDescriptors();
    ...
    _renders: {
        ...
        option: function (descriptor) {
            ...
            if (text != label) {
                ...
                $option.attr('data-field-label', label);
            }
