...
/**
 * Binds all the dropdowns in the stalker on view issue
 */
JIRA.Dropdowns.bindStalkerDds = function () {
...
AJS.$(function () {
    ...
    JIRA.Dropdowns.bindIssueActionsDds();
    JIRA.Dropdowns.bindNavigatorOptionsDds();
    JIRA.Dropdowns.bindStalkerDds();
