...
jQuery(function () {
    ...
    AJS.$("fieldset.content-toggle input[type='radio']").live("change", function(){
        var $this = AJS.$(this);
        $this.closest(".content-toggle").find("input[type='radio']").each(function(){
            AJS.$("#" + AJS.$(this).attr("name") + "-" + AJS.$(this).val() + "-content").hide();
        });

        AJS.$("#" + $this.attr("name") + "-" + $this.val() + "-content").show();
    });
});
...
jQuery(function () {
    ...
    AJS.$("#issuenav").bind("contractBlock expandBlock", function () {
...
AJS.$(function(){
    ...
    AJS.$(".page-type-admin .content-container.aui-tabs > .content-related .tabs-menu a").unbind("click");
});