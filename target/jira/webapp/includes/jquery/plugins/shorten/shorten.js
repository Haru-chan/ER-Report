...
AJS.Shortener = Class.extend({
    ...
    _isShortenedOnLoad: function () {
        var cookieValue = localStorage.getItem("shorten-" + this.$container.attr("id"));
    ...
    shorten: function (moveToShortened) {
        ...
        if (this.options.persist) {
            localStorage.setItem("shorten-" + this.$container.attr("id"), "hidden");
        }
    ...
    expand: function () {
        ...
        if (this.options.persist) {
            localStorage.setItem("shorten-" + this.$container.attr("id"), "shown");
        }
