...
<body>
    <header>
        ...
        <div id="heading-avatar">
            <img alt="<ww:property value="user/fullName" />" height="48" src="<ww:url page="/secure/useravatar"><ww:param name="'size'" value="'large'"/><ww:param name="'ownerId'" value="user/name"/><ww:param name="'avatarId'" value="/avatarId(user)"/></ww:url>" width="48" />
        </div>
        <h1 id="up-user-title"><ww:text name="'common.concepts.profile'"/>: <span id="up-user-title-name"><ww:property value="user/displayName"/></span></h1>
    </header>
